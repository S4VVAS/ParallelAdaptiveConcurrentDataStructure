...
public class OnlineAdaptiveConcurrentNonBlocking<E> implements Iterable<E> {
	...
	private AtomicReference<CopyOnWriteArrayList<E>> listRef;
	...
	public OnlineAdaptiveConcurrentNonBlocking() {
		this(State.LIST, true);
	}

	public OnlineAdaptiveConcurrentNonBlocking(State state) {
		this(state, true);
	}
